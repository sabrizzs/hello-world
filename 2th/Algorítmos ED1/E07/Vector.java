/******************************************************************************
 *  Compilation:  javac-introcs Vector.java
 *  Execution:    java-introcs Vector
 *
...
*/
    ...
    public static void main(String[] args) {
        double[] xdata = { 5.0, 2.0 };
        double[] ydata = { 3.0, 2.0};
        double[] val1 = { 0.0, 1.0};
        double[] val2 = { -1.0, 1.0};

        Vector x = new Vector(xdata);
        Vector y = new Vector(ydata);
        Vector z = new Vector(val1);
        Vector w = new Vector(val2);
        ...
        StdOut.println("y        =  " + y);
        StdOut.println("z        =  " + z);
        StdOut.println("x * y      =  " + x.dot(z));
        StdOut.println("cartesiano       =  " + x.cartesian(0)*-1);
