...
function main() {
    ...
    */
    ...
    //gObjetos.push(new Disco(0, 0, sorteieInteiro(50, 80), -50, 100, sorteieCorRGBA()));
...
function atualizaTela() {
    ...
    */
    ...
    // Está redesenhando e atualizando as posições
    gPosicoes = [];
    for (let i = 0; i < gObjetos.length; i++) {
        gObjetos[i].atualize(dt);
    }
    for (let i = 0; i < mObjetos.length; i++) {
        mObjetos[i].atualize(dt);
    }
...
class Inseticida {
    ...
    aumentaAltura() {
        ...
        gObjetos[2].atualize(this.larguraBase, this.alturaBase);
    }
    diminuiAltura() {
...
class Mosquito {
    ...
    desenha() {
        // Corpo mosquito
        mObjetos.push(new Quadrado(this.x, this.y, this.larDengue, this.vx, this.vy, COR_DENGUE));
        // Asa direita
        mObjetos.push(new Triangulo(this.x + this.larDengue/2, this.y, this.larDengue*0.6, this.vx, this.vy, this.corAsas));
        // Asa esquerda
        mObjetos.push(new Triangulo(this.x - this.larDengue/2, this.y, this.larDengue*0.6, this.vx, this.vy, this.corAsas, -1));
        // Olho direito
        mObjetos.push(new Quadrado(this.x + this.larDengue/4, this.y, this.larDengue/5, this.vx, this.vy, this.corOlhos));
        // Olho esquerdo
        mObjetos.push(new Quadrado(this.x - this.larDengue/4, this.y, this.larDengue/5, this.vx, this.vy, this.corOlhos));
    }
}
...
function Triangulo(x, y, lado, vx, vy, cor, orientacao = 1) {
...
function Quadrado(x, y, lado, vx, vy, cor) {
    this.vertices = [
